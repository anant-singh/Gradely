...
!function (a, b) {
    ...
    d.event = {bindDom: function (a, b, c) {
        ...
        return(e.type.match(/mouse/) || d.PointerEvent.matchType(d.POINTER_MOUSE, e)) && (f = d.POINTER_MOUSE), {center: d.utils.getCenter(c), timeStamp: (new Date).getTime(), target: e.target, touches: c, eventType: b, pointerType: f, srcEvent: e, preventDefault: function () {
        ...
        for (var b, c = [], d = [], e = 0, f = a.length; f > e; e++)b = a[e], c.push("undefined" != typeof b.clientX ? b.clientX : b.pageX), d.push("undefined" != typeof b.clientY ? b.clientY : b.pageY);
        return{pageX: (Math.min.apply(Math, c) + Math.max.apply(Math, c)) / 2, pageY: (Math.min.apply(Math, d) + Math.max.apply(Math, d)) / 2}
        ...
        var f, g, h = a.timeStamp - b.timeStamp, i = a.center.pageX - b.center.pageX, j = a.center.pageY - b.center.pageY, k = d.utils.getVelocity(h, i, j);
        return"end" === a.eventType ? (f = this.current.lastEvent && this.current.lastEvent.interimAngle, g = this.current.lastEvent && this.current.lastEvent.interimDirection) : (f = this.current.lastEvent && d.utils.getAngle(this.current.lastEvent.center, a.center), g = this.current.lastEvent && d.utils.getDirection(this.current.lastEvent.center, a.center)), d.utils.extend(a, {deltaTime: h, deltaX: i, deltaY: j, velocityX: k.x, velocityY: k.y, distance: d.utils.getDistance(b.center, a.center), angle: d.utils.getAngle(b.center, a.center), interimAngle: f, direction: d.utils.getDirection(b.center, a.center), interimDirection: g, scale: d.utils.getScale(b.touches, a.touches), rotation: d.utils.getRotation(b.touches, a.touches), startEvent: b}), a
    }, register: function (a) {
        var c = a.defaults || {};
...
(function (e, t, n) {
    ...
    e.fn.dropdownHover = function (n) {
        ...
        return this.each(function () {
            var i = e(this), s = i.parent(), o = {delay: 100, instantlyCloseOthers: !0}, u = {delay: e(this).data("delay"), instantlyCloseOthers: e(this).data("close-others")}, a = e.extend(!0, {}, o, n, u), f;
            s.hover(function (n) {
...
!function (t) {
    ...
    e.defaults = {transition_delay: 300, refresh_speed: 50, display_text: "none", use_percentage: !0, percent_format: function (t) {
        ...
        var n = this.$element, s = n.parent(), a = t('<div class="progress-tooltip"/>'), i = this.$back_text, r = this.$front_text, o = this.options, h = n.attr("aria-valuetransitiongoal"), p = n.attr("aria-valuemin") || 0, f = n.attr("aria-valuemax") || 100, c = s.hasClass("vertical"), d = o.update && "function" == typeof o.update ? o.update : e.defaults.update, u = o.done && "function" == typeof o.done ? o.done : e.defaults.done, l = o.fail && "function" == typeof o.fail ? o.fail : e.defaults.fail;
        if (!h)return l("aria-valuetransitiongoal not set"), void 0;
        var g = Math.round(100 * (h - p) / (f - p));
        if ("center" === o.display_text && !i && !r) {
            this.$back_text = i = t("<span>", {"class": "progressbar-back-text"}).prependTo(s), this.$front_text = r = t("<span>", {"class": "progressbar-front-text"}).prependTo(n);
            var _;
            c ? (_ = s.css("height"), i.css({height: _, "line-height": _}), r.css({height: _, "line-height": _}), t(window).resize(function () {
                _ = s.css("height"), i.css({height: _, "line-height": _}), r.css({height: _, "line-height": _})
            })) : (_ = s.css("width"), r.css({width: _}), t(window).resize(function () {
                _ = s.css("width"), r.css({width: _})
            }))
        }
        setTimeout(function () {
            var t, e, l, _, v;
            c ? n.css("height", g + "%") : n.css("width", g + "%");
            var x = setInterval(function () {
                c ? (l = n.height(), _ = s.height()) : (l = n.width(), _ = s.width()), t = Math.round(100 * l / _), e = Math.round(l / _ * (f - p)), t >= g && (t = g, e = h, u(), clearInterval(x)), "none" !== o.display_text && (v = o.use_percentage ? o.percent_format(t) : o.amount_format(e, f), "fill" === o.display_text ? n.text(v) : "tooltip" === o.display_text ? (a.prependTo(n), a.text(v)) : "center" === o.display_text && (i.text(v), r.text(v))), n.attr("aria-valuenow", e), d(t)
            }, o.refresh_speed)
        }, o.transition_delay)
    };
    ...
    t.fn.progressbar = function (n) {
        return this.each(function () {
            var s = t(this), a = s.data("bs.progressbar"), i = "object" == typeof n && n;
...
!function (e) {
    ...
    n.prototype = {constructor: n, init: function (t, n) {
        ...
        })), n.$element.on("destroy.modalmanager", t(function () {
            o.removeModal(n)
        }))
        ...
        var a = t.$element.hasClass("fade") ? "fade" : "", s = t.options.backdrop && this.backdropCount < this.options.backdropLimit;
        if (t.isShown && s) {
    ...
    var o = function () {
        ...
        return function (o, a) {
            if ("undefined" == typeof t) {
                var s = e('<div class="modal hide" />').appendTo("body"), i = e('<div class="modal-backdrop hide" />').appendTo("body");
...
!function (t) {
    ...
    i.prototype = {constructor: i, init: function (i, e) {
        var n = this;
        this.options = e, this.$element = t(i).delegate('[data-dismiss="modal"]', "click.dismiss.modal", t.proxy(this.hide, this)), this.options.remote && this.$element.find(".modal-body").load(this.options.remote, function () {
            var i = t.Event("loaded");
            n.$element.trigger(i)
        });
        ...
        var i = t.Event("show");
        this.isShown || (this.$element.trigger(i), i.isDefaultPrevented() || (this.escape(), this.tab(), this.options.loading && this.loading()))
    }, hide: function (i) {
        return i && i.preventDefault(), i = t.Event("hide"), this.$element.trigger(i), !this.isShown || i.isDefaultPrevented() ? this.isShown = !1 : (this.isShown = !1, this.escape(), this.tab(), this.isLoading && this.loading(), t(document).off("focusin.modal"), this.$element.removeClass("in").removeClass("animated").removeClass(this.options.attentionAnimation).removeClass("modal-overflow").attr("aria-hidden", !0), t.support.transition && this.$element.hasClass("fade") ? this.hideWithTransition() : this.hideModal(), void 0)
    }, layout: function () {
        var i = this.options.height ? "height" : "max-height", e = this.options.height || this.options.maxHeight;
        ...
        this.$element.find(".modal-body").css("overflow", "").css(i, ""), e && this.$element.find(".modal-body").css("overflow", "auto").css(i, e);
        ...
        this.isShown && this.options.consumeTab ? this.$element.on("keydown.tabindex.modal", "[data-tabindex]", function (e) {
            if (e.keyCode && 9 == e.keyCode) {
                var n = t(this), s = t(this);
                i.$element.find("[data-tabindex]:enabled:not([readonly])").each(function (i) {
                    n = i.shiftKey ? n.data("tabindex") > t(this).data("tabindex") ? n = t(this) : s = t(this) : n.data("tabindex") < t(this).data("tabindex") ? n = t(this) : s = t(this)
                }), n[0] !== t(this)[0] ? n.focus() : s.focus(), e.preventDefault()
            }
        }) : this.isShown || this.$element.off("keydown.tabindex.modal")
    }, escape: function () {
        var t = this;
        this.isShown && this.options.keyboard ? (this.$element.attr("tabindex") || this.$element.attr("tabindex", -1), this.$element.on("keyup.dismiss.modal", function (i) {
            27 == i.which && t.hide()
        })) : this.isShown || this.$element.off("keyup.dismiss.modal")
    }, hideWithTransition: function () {
        var i = this, e = setTimeout(function () {
            i.$element.off(t.support.transition.end), i.hideModal()
        }, 500);
        this.$element.one(t.support.transition.end, function () {
            clearTimeout(e), i.hideModal()
        })
    }, hideModal: function () {
        var t = this.options.height ? "height" : "max-height", i = this.options.height || this.options.maxHeight;
        i && this.$element.find(".modal-body").css("overflow", "").css(t, ""), this.$element.hide().trigger("hidden")
    }, removeLoading: function () {
        ...
        } else i && i(this.isLoading); else {
            var s = t.support.transition && e;
            this.$loading = t('<div class="loading-mask ' + e + '">').append(this.options.spinner).appendTo(this.$element), s && this.$loading[0].offsetWidth, this.$loading.addClass("in"), this.isLoading = !0, s ? this.$loading.one(t.support.transition.end, i) : i()
        }
    }, focus: function () {
        ...
        var i = t.Event("destroy");
        this.$element.trigger(i), i.isDefaultPrevented() || this.teardown()
    }, teardown: function () {
        return this.$parent.length ? (this.$parent !== this.$element.parent() && this.$element.appendTo(this.$parent), this.$element.off(".modal"), this.$element.removeData("modal"), this.$element.removeClass("in").attr("aria-hidden", !0), void 0) : (this.$element.remove(), this.$element = null, void 0)
    }}, t.fn.modal = function (e, n) {
        return this.each(function () {
            var s = t(this), o = s.data("modal"), a = t.extend({}, t.fn.modal.defaults, s.data(), "object" == typeof e && e);
            o || s.data("modal", o = new i(this, a)), "string" == typeof e ? o[e].apply(o, [].concat(n)) : a.show && o.show()
        })
    }, t.fn.modal.defaults = {keyboard: !0, backdrop: !0, loading: !1, show: !0, width: null, height: null, maxHeight: null, modalOverflow: !1, consumeTab: !0, focusOn: null, replace: !1, resize: !1, attentionAnimation: "shake", manager: "body", spinner: '<div class="loading-spinner" style="width: 200px; margin-left: -100px;"><div class="progress progress-striped active"><div class="bar" style="width: 100%;"></div></div></div>', backdropTemplate: '<div class="modal-backdrop" />'}, t.fn.modal.Constructor = i, t(function () {
        t(document).off("click.modal").on("click.modal.data-api", '[data-toggle="modal"]', function (i) {
            var e = t(this), n = e.attr("href"), s = t(e.attr("data-target") || n && n.replace(/.*(?=#[^\s]+$)/, "")), o = s.data("modal") ? "toggle" : t.extend({remote: !/#/.test(n) && n}, s.data(), e.data());
            i.preventDefault(), s.modal(o).one("hide", function () {
                e.focus()
            })
        })
    })
...
!function (t) {
    ...
    e.prototype = {constructor: e, layout: function () {
        var n = [], e = this.padding;
        ...
        return this.each(function () {
            var o = t(this), d = o.data("tabdrop"), i = "object" == typeof n && n;
            d || o.data("tabdrop", d = new e(this, t.extend({}, t.fn.tabdrop.defaults, i))), "string" == typeof n && d[n]()
        })
    }, t.fn.tabdrop.defaults = {text: '<i class="fa fa-align-right"></i>'}, t.fn.tabdrop.Constructor = e
}(window.jQuery);
