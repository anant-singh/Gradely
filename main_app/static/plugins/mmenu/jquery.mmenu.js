    ...
    if (!a[b]) {
        ...
        a[b] = function (a, b, c) {
            ...
            d.each(function (c) {
                ...
                var d = a(this), f = d.is("ul") ? d : d.find("ul").first(), h = d.parent(), i = h.find("> a, > span"), j = h.closest("." + e.panel);
            ...
            var b = this, c = a("ul." + e.list + " > li > a", this.$menu).not("." + e.subopen).not("." + e.subclose).not('[rel="external"]').not('[target="_blank"]');
        ...
        }, a[b].version = c, a[b].defaults = {position: "left", zposition: "back", moveBackground: !0, slidingSubmenus: !0, modal: !1, classes: "", onClick: {setSelected: !0}}, a[b].configuration = {preventTabbing: !0, panelClass: "Panel", listClass: "List", selectedClass: "Selected", labelClass: "Label", pageNodetype: "div", panelNodeType: "ul, div", transitionDuration: 400}, function () {
