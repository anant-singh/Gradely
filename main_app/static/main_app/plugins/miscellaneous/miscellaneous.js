...
(function (i, k) {
    function e(a) {
        ...
        this.getRGB = function () {
            return this.c ? {r: this.r,
                g: this.g, b: this.b, a: this.a} : null
        };
    ...
    var o = {aliceblue: "f0f8ff",
        ...
        steelblue: "4682b4", tan: "d2b48c", teal: "008080", thistle: "d8bfd8", tomato: "ff6347", turquoise: "40e0d0", violet: "ee82ee", wheat: "f5deb3", white: "fff", whitesmoke: "f5f5f5", yellow: "ff0", yellowgreen: "9acd32"}, p;
 ...
 */
!function (t) {
    var i = {life: 1e4, theme: "default", iconClose: "fa fa-times", sticky: !1, verticalEdge: "right", horizontalEdge: "top", zindex: 1100}, e = {init: function (n, a) {
        return this.each(function () {
            var s = t(this), o = s.data("notific8");
            s.data("notific8", {target: s, settings: {}, message: ""}), o = s.data("notific8"), o.message = n, t.extend(o.settings, i, a), e._buildNotification(s)
        })
    }, destroy: function (i) {
        i.data("notific8");
...
!function (e) {
    ...
    e.support.fullscreen = n(), e.fn.fullScreen = function (n) {
        ...
        if (c())return u(), this;
        var r = e.extend({background: "#111", callback: e.noop(), fullscreenClass: "fullScreen"}, n), o = this, s = e("<div>", {css: {"overflow-y": "auto", background: r.background, width: "100%", height: "100%"}}).insertBefore(o).append(o);
...
(function (p) {
    ...
    Throbber = function (d) {
        ...
        isNaN(d) || (d = {size: d});
        this.o = {size: 32, rotationspeed: 6, clockwise: !0, color: "#d3d3d3", fade: 300, fallback: !1, alpha: 1};
        this.configure(d);
        this.phase = -1;
    ...
    Throbber.prototype = {constructor: Throbber, appendTo: function (d) {
        ...
        h(b, h({padding: b.size / 2, strokewidth: e.max(1, e.min(b.size / 30, 3)), lines: e.min(30, b.size / 2 + 4), alpha: c || 1, fps: e.min(30, b.size +
            4)}, d));
        b.color = a;
        this.step = b.lines;
        return this
...
(function (a, b, c) {
    ...
    b.Isotope.settings = {resizable: !0, layoutMode: "masonry", containerClass: "isotope", itemClass: "isotope-item", hiddenClass: "isotope-hidden", hiddenStyle: {opacity: 0, scale: .001}, visibleStyle: {opacity: 1, scale: 1}, containerStyle: {position: "relative", overflow: "hidden"}, animationEngine: "best-available", animationOptions: {queue: !1, duration: 800}, sortBy: "original-order", sortAscending: !0, resizesContainer: !0, transformsEnabled: !b.browser.opera, itemPositionDataEnabled: !1}, b.Isotope.prototype = {_create: function (a) {
        ...
        this.options.getSortData = b.extend(this.options.getSortData, h), this.reloadItems(), this.offset = {left: parseInt(this.element.css("padding-left"), 10), top: parseInt(this.element.css("padding-top"), 10)};
        var i = this;
        setTimeout(function () {
        ...
        a.filter(":not(." + this.options.hiddenClass + ")").length ? (this.styleQueue.push({$el: a, style: this.options.hiddenStyle}), this.$filteredAtoms = this.$filteredAtoms.not(a), this._sort(), this.reLayout(d, b)) : (d(), b && b.call(this.element))
    }, shuffle: function (a) {
...
!function (t, e, s, i) {
    ...
    var h = {listNodeName: "ol", itemNodeName: "li", rootClass: "dd", listClass: "dd-list", itemClass: "dd-item", dragClass: "dd-dragel", handleClass: "dd-handle", collapsedClass: "dd-collapsed", placeClass: "dd-placeholder", noDragClass: "dd-nodrag", emptyClass: "dd-empty", expandBtnHTML: '<button data-action="expand" type="button">Expand</button>', collapseBtnHTML: '<button data-action="collapse" type="button">Collapse</button>', group: 0, maxDepth: 5, threshold: 20};
    a.prototype = {init: function () {
        ...
        this.dragEl.css({left: i.pageX - p.offsetX, top: i.pageY - p.offsetY}), p.lastX = p.nowX, p.lastY = p.nowY, p.nowX = i.pageX, p.nowY = i.pageY, p.distX = p.nowX - p.lastX, p.distY = p.nowY - p.lastY, p.lastDirX = p.dirX, p.lastDirY = p.dirY, p.dirX = 0 === p.distX ? 0 : p.distX > 0 ? 1 : -1, p.dirY = 0 === p.distY ? 0 : p.distY > 0 ? 1 : -1;
